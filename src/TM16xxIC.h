...
This generic class supports most 2 and 3 wire TM16xx chips, but may have a larger footprint than
the chip specific class. Other than having a different constructor the API of the generic class
is compatible with the chip-specific classes.
...
/**/ #define IC_TM1623  if_ctrl_tm16xx {TM16XX_IFTYPE_4WSPI, 5, 7, TM16XX_IC_SEGMUX_3 | TM16XX_IC_SEGBYTES_2, 0x3FFF, 5, 0x3F}  // SxG: 14x4-11x7 CC/CA, K:8x3
...
#define IC_TM1630  if_ctrl_tm16xx {TM16XX_IFTYPE_3WSER, 5, 5, TM16XX_IC_SEGMUX_1 | TM16XX_IC_SEGBYTES_2, 0x00FF, 4, 0xFF}  // chinese datasheet
...
/**/ #define IC_TM1648A if_ctrl_tm16xx {TM16XX_IFTYPE_2WI2C, 5, 7, TM16XX_IC_SEGMUX_3 | TM16XX_IC_SEGBYTES_2, 0x00FF, 1, 0xFF}  // SxG: 13x4-10x7 CC/CA, K:8x1 touch, i2C @50, 1x buz
/**/ #define IC_TM1649  if_ctrl_tm16xx {TM16XX_IFTYPE_5WSPI, 5, 7, TM16XX_IC_SEGMUX_0 | TM16XX_IC_SEGBYTES_2, 0x00FF, 4, 0xFF}  // no datasheet
...
/**/ #define IC_TM1680  if_ctrl_tm16xx {TM16XX_IFTYPE_2WI2C, 5, 96,TM16XX_IC_SEGMUX_8 | TM16XX_IC_SEGBYTES_NIB, 0x0F0F, 0, 0x00}  // SxG: 32x8/24x16; A0 must be wired low for 7-bit I2C address 0x73, see issue #2, 16 level duty
/**/ #define IC_TM1681  if_ctrl_tm16xx {TM16XX_IFTYPE_4WSPI, 5, 96,TM16XX_IC_SEGMUX_8 | TM16XX_IC_SEGBYTES_NIB, 0x0F0F, 0, 0x00}  // like TM1680, but 4WSPI interface
